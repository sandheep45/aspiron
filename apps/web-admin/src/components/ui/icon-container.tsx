...
export const iconContainerVariants = cva(
  'rounded-xl p-4 border transition-transform group-hover:scale-105',
  {
    variants: {
      variant: {
        danger: severityVariants({ severity: 'danger' }),
        warning: severityVariants({ severity: 'warning' }),
        success: severityVariants({ severity: 'success' }),
        info: severityVariants({ severity: 'info' }),
        neutral: severityVariants({ severity: 'neutral' }),
      },
    },
    defaultVariants: {
      variant: 'neutral',
