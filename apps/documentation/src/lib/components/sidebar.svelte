...
<aside
  class="fixed inset-y-0 left-0 z-50 w-64 transform border-r border-surface-200-800 bg-white dark:bg-surface-900 py-4 transition-transform duration-300 ease-in-out lg:translate-x-0 lg:transform-none lg:sticky lg:top-16 lg:h-[calc(100vh-4rem)] lg:overflow-y-auto lg:py-4"
...
>
  <div class="flex items-center justify-between px-4 pb-4 lg:hidden">
    <h2
      class="text-xs font-semibold uppercase tracking-wider text-surface-500-400"
    >
      Documentation
    </h2>
    <button
