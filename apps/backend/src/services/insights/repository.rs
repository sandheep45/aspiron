...
use crate::entries::dtos::response::insights::TopicPerformance;
...
use crate::entries::entities::content_topic::Column as TopicColumn;
use crate::entries::entities::content_topic::Entity as TopicEntity;
